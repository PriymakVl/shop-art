...
use app\models\materials\CanvasSearch;
use app\controllers\AppController;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CanvasAdminController implements the CRUD actions for Canvas model.
 */
class CanvasAdminController extends AppController
{
    public $layout = 'admin';
    ...
    {
        if (($model = Canvas::findOne(['id' => $id])) !== null) {
            return $model;
        }
