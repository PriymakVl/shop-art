...
use app\models\subscribers\SubscriberSearch;
...
/**
 * SubscriberAdminController implements the CRUD actions for Subscriber model.
 */
class SubscriberAdminController extends AppController
{
    public $layout = 'admin';
    ...
    public function actionCreate()
    {
        ...
        if ($model->load($this->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', 'Subscription successfully completed ');
        }
        else Yii::$app->session->setFlash('error', 'An error occurred while subscribing ');
